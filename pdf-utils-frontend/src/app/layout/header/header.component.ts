 ...
 * the width toggle is hidden (wide mode is a desktop feature) and the pickers
 * move into the off-canvas drawer, so the top bar never wraps into extra rows.
 */
@Component({
  selector: 'app-header',
  standalone: true,
  imports: [RouterLink, TranslocoModule, SecondaryControlsComponent],
